...
Rule 0 (CRITICAL): Use the subreddit as a strong geographic hint or filter. If the subreddit is a specific country or region (e.g. r/europe, r/india), the event most likely happened there. If it's a global subreddit (e.g. r/worldnews, r/news), rely entirely on the text.
Rules:
...
async def resolve_geo_for_candidate(
    ...
    try:
        ...
        prompt = GEO_RESOLVE_PROMPT.format(
