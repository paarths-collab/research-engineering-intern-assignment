...
# Priorities: 1. ENV['DATA_PATH'], 2. /app/data (Production), 3. Local project root /data
DATA_DIR = os.getenv("DATA_PATH", "/app/data" if os.path.exists("/app/data") else os.path.join(os.path.dirname(__file__), "..", "..", "data"))
